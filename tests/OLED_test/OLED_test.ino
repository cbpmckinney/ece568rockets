...
#define OLED_RESET -1     // can set an oled reset pin if desiredg:\Desktop\School\Semesters\Purdue 2025 Spring\ECE568\Ground Station\ece568rockets\ground_station\src\OLEDManager.h
